...
class IsaacGym(BaseSimulator):
    ...
    def load_assets(self):
        ...
        print(self.num_dof, self.num_bodies, self.dof_names, self.body_names)
        ...
        print(self.robot_config.dof_names)
    ...
    def _setup_robot_asset_when_env_created(self, asset_root, asset_file, asset_cfg):
        ...
        print(f"Loaded asset: {gym_asset_root}/ {gym_asset_file}")
    ...
    def _process_rigid_body_props(self, props, env_id):
        ...
        if self.env_config.domain_rand.randomize_base_com:
            ...
            try:
                ...
                torso_index = self._body_list.index(self.robot_config.torso_name) # for fixed upper URDF we only have pelvis link
        ...
        if self.env_config.domain_rand.randomize_base_mass:
            ...
            try:
                ...
                base_index = self._body_list.index(self.robot_config.torso_name)
            assert base_index != -1
