...
def main(cfg : DictConfig) -> None:
    ...
    # humanoid_xml = "./description/robots/hi/mjcf/hi_host_2fitsmpl.xml"
    # humanoid_xml = "./description/robots/pi+/xml/pi_box_l_g.xml"
    humanoid_xml = "./description/robots/pi+_all/pi_plus_20dof_250828/xml/pi_20dof_0828.xml"
    # humanoid_xml = "./description/robots/hi_peixing/hi_peixing_box.xml"
    ...
    with mujoco.viewer.launch_passive(mj_model, mj_data, key_callback=key_call_back) as viewer:
        ...
        while viewer.is_running():
            ...
            if vis_contact: 
                ...
                viewer.user_scn.geoms[15].rgba = np.array([0, 1-curr_motion['contact_mask'][curr_time, 1], 0, 1])
